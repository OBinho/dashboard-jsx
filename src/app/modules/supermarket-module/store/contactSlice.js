...
export const getContact = createAsyncThunk(
  ...
  async (id, { dispatch, getState }) => {
    try {
      const response = await axios.get(`http://localhost:8080/supermarket/${id}`);
...
export const addContact = createAsyncThunk(
  ...
  async (contact, { dispatch, getState }) => {
    const response = await axios.post('http://localhost:8080/supermarket', contact);
...
export const updateContact = createAsyncThunk(
  ...
  async (contact, { dispatch, getState }) => {
    const response = await axios.put(`http://localhost:8080/supermarket/${contact.id}`, contact);
